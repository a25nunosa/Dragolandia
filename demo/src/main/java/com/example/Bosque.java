...
public class Bosque {
    ...
    public Bosque () {}
     ...
     public Bosque(String nombre, int peligro, Monstruo monstruo) {
    ...
    public Bosque(int id, String nombre, int peligro, Monstruo monstruo) {
        this.id = id;
        this.nombre = nombre;
        this.peligro = peligro;
        this.monstruo = monstruo;
    ...
    public void mostrarJefe() {
            System.out.println("monstruo Jefe del bosque " + nombre + ":");
            System.out.println(monstruo);
        }

    public void cambiarJefe(Monstruo nuevoJefe) {
            this.monstruo = nuevoJefe;
            System.out.println("nuevo jefe del bosque: " + nuevoJefe.getNombre());
        }
}